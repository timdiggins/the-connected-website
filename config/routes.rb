ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :posts, :has_many => [ :comments], :member => { :feature => :put, :unfeature => :put, :subscribe => :post, :unsubscribe => :post }, :collection => { :featured => :get }, :new => { :upload => :any, :video => :any } do | post |
